...
def config():
    ...
    segmenter = {
        ...
        'max_grid_w': 500,  # 10s audio @16kHz with 320 samples shift
    ...
    if database_name == 'desed':
        external_data = True
        batch_size = 32 * 3  # est. 45GB GPU memory
        data_provider = {
        ...
        gradient_clipping = 1 if finetune_mode else 1  # TODO: find good value, is higher for transformer -> use deepnor or other method?
    ...
    trainer = {
        ...
        'model': {
            ...
            'patch_embed': {'factory': PatchEmbed,
                            ...
                            'embed_dim': 512,
                            'output_dim': 768,
                            'flatten_transpose': True, # should be necessary for variable-length ViT, independent of grid width
                            'bias': False,
                            # 'learnable': False,
                            # 'image_net_init_path': '/net/home/werning/pretrained/mae_pretrain_vit_base.pth'
                            },
            'predictor': {'factory': PredictorHead,
                          'patch_embed_dim': 768,
                          'num_classes': num_events,
                          'classifier_hidden_dims': [768, 768],
                          'pooling_op': 'concat',
            ...
            'init': '/net/home/werning/pretrained/BEATs_iter3.pt',
        },
        'optimizer': {
            'factory': AdamW,
            'lr': lr,
